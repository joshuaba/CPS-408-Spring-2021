...
def mainMenu():
    ...
    userOption = int(input("Please input the number associated with the option you would like to perform: "))
    ...
    if(userOption == 1):
        ...
        repeat = True
        while(repeat):
            tableOutput = input("From which table would you like to print the records: \n\
                                  1: Faculty\n\
                                  2: Courses\n\
                                  3: Department\n\
                                  4: Schools\n\
        ...
        detailedView = input("Would you like to see a detailed view of the assignments (as in instructor of the course, course name, etc.? Typing \"N\" will only print out the Assignment and its related details\
                       rather than a detailed list including instructor details, course details, etc.")
        ...
        if(detailedView == 'Y' or detailedView == 'y'):
            ...
            while (repeat):
                ...
                if (parameterChosen == 1):
                    ...
                    DBQueries.printAssignmentsCoursesDepartmentInfo(facultyName)
                    repeat = False
                elif (parameterChosen == 2):
                    courseName = input("Name of course: ")
                    DBQueries.printAssignmentsCoursesFacultyInfo(courseName)
                    repeat = False
                    ...
                    DBQueries.printAssignmentsCoursesDepartmentCollegeInfo(departmentName)
                    repeat = False
                elif (parameterChosen == 4):
                    schoolName = input("School/College Name: ")
                    DBQueries.printAssignmentsCoursesInfo(schoolName)
                    repeat = False
                else:
                    print(
            ...
            while(repeat):
                ...
                if (parameterChosen == 1):
                    facultyName = input("Name of faculty member: MUST BE in FirstName LastName format (with a space) ")
                    DBQueries.filterAssignmentsOutStandingByFaculty(facultyName)
                    repeat = False
                elif (parameterChosen == 2):
                    courseName = input("Name of course: ")
                    DBQueries.filterAssignmentsOutStandingByCourse(courseName)
                    repeat = False
                elif (parameterChosen == 3):
                    departmentName = input("Name of department: ")
                    # InsertValues.filterAssignmentsOutstandingByDepartment(departmentName)
                    DBQueries.assignmentDepartmentSubQuery(departmentName)
                    repeat = False
                elif (parameterChosen == 4):
                    schoolName = input("School/College Name: ")
                    DBQueries.filterAssignmentsOutStandingBySchool(schoolName)
                    repeat = False
                else:
                    print(
                        "Unrecognized input. Please type a value from 1 - 4, depending on the table from which you would like to print the records")
